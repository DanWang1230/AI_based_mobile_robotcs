...
from RRTPlannerNonholonomic_multiruns  import RRTPlannerNonholonomic_multiruns
...
if __name__ == "__main__":
    ...
    planning_env = CarEnvironment(map2, start, goal)
    ...
    for i in range(10):
        np.random.seed(i)
        planner = RRTPlannerNonholonomic_multiruns(planning_env, bias=0.05) # RRTPlanner_multiruns for RRT
        plan, cost, plan_time = planner.Plan(start, goal)
        costs.append(cost)
